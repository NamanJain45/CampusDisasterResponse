    ...
    fun getLatestStatuses(token: String): Result<List<StudentSafetyStatus>> = try {
        ...
        try {
            ...
            Result.success(List(array.length()) { i ->
                ...
                StudentSafetyStatus(o.getString("id"), o.getString("name"), o.getString("email"), o.optString("role", "STUDENT"), o.optString("status", "UNKNOWN"), o.optString("message").ifBlank { null }, o.optString("updatedAt").ifBlank { null })
            })
