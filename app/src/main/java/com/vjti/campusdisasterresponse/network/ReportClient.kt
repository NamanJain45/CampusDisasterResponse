...
class ReportClient(private val baseUrl: String = "http://192.168.0.115:3000") {
        ...
        return try {
            ...
            try {
                ...
                val body = JSONObject().apply {
                    ...
                    put("locationText", request.locationText)
                ...
                when (connection.responseCode) {
                    401, 403 -> ReportResult.AUTH_REQUIRED
                    in 200..299 -> ReportResult.SUCCESS
                    else -> ReportResult.FAILURE
                }
            } finally {
